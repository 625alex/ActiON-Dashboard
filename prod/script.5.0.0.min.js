...
$(function() {
	...
	$(".thermostatHeat .up, .thermostatCool .up").click(function(){
		...
		var tile = $(this);
		thermostatTimer = setTimeout(function(){alert("1: " + tile.attr("data-setpoint")); sendThermostatEvent(tile)}, 500);
	});
});

function sendThermostatEvent(tile) {
	alert("2: " + tile.attr("data-setpoint"));
}
